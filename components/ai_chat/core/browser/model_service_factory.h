...
#ifndef BRAVE_COMPONENTS_AI_CHAT_CORE_BROWSER_MODELS_FACTORY_H_
#define BRAVE_COMPONENTS_AI_CHAT_CORE_BROWSER_MODELS_FACTORY_H_
...
#endif  // BRAVE_COMPONENTS_AI_CHAT_CORE_BROWSER_MODELS_FACTORY_H_
